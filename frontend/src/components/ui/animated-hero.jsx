      ...
      <div className="container mx-auto">
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
          <div className="flex gap-4 flex-col">
            ...
            <p className="text-lg md:text-xl leading-relaxed tracking-tight text-blue-100 max-w-2xl text-center px-4">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="inline-flex items-center justify-center gap-4 h-11 rounded-md px-8 text-base font-semibold bg-white text-blue-600 hover:bg-gray-100 transition-colors"
            >
