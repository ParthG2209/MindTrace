    ...
    <div className="space-y-3">
      {segments.map((segment) => (
        <div
          ...
          className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg shadow-md overflow-hidden hover:bg-white/10 hover:border-white/20 transition-all"
        >
          <div
            onClick={() =>
              setExpandedSegment(
          ...
          >
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center ml-4">
                <span
                  className={`px-3 py-1 rounded-lg text-sm font-semibold border backdrop-blur-sm ${getScoreBadgeColor(
                    segment.overall_segment_score
                  )}`}
                >
            ...
            <div className="px-4 pb-4 pt-2 bg-white/5 border-t border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={key} className="bg-white/5 p-3 rounded-lg border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors">
                    ...
                    <p className="text-xs text-gray-400 mt-1">{segment[key].reason}</p>
                  </div>
                ))}
              </div>
            </div>
